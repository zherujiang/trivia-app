...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_database_name = "trivia_test"
        user_spec = DB_USER + ':' + DB_PASSWORD
        if len(user_spec) > 1:
            self.database_path = 'postgresql://' + user_spec + '@{}/{}'.format('localhost:5432', self.test_database_name)
        else:
            self.database_path = 'postgresql://{}/{}'.format('localhost:5432', self.test_database_name)
